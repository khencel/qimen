...
class CreateNWSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('n_w_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('nwBottom')->nullable();
            $table->string('nwRight')->nullable();
            $table->timestamps();
        });
    }

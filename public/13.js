...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    suitAvoidList: function suitAvoidList() {
      var _this3 = this;

      axios.get('/api/tong-shu/dong-gong/suit-avoid/list').then(function (res) {
        _this3.suit_avoid_list = res.data;
      });
    },
    storeSuit: function storeSuit() {
      var data = this.selected_suit;
      this.suit_avoid_list = this.suit_avoid_list.filter(function (item) {
    ...
    storeAvoid: function storeAvoid() {
    ...
    clearSuit: function clearSuit() {
      this.data.selected_suit_list = [];
      this.suitAvoidList();
    },
    clearAvoid: function clearAvoid() {
            ...
            _c("tbody", [
              ...
              _c("tr", [
                _c(
                  "td",
                  [
                    _c("label", { attrs: { for: "" } }, [_vm._v("Suit")]),
                    _vm._v(" "),
                    _c("br"),
                    _vm._v(" "),
                    _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.selected_suit,
                            expression: "selected_suit"
                          }
                        ],
                        staticClass: "form-control",
                        on: {
                          change: [
                            function($event) {
                              ...
                              _vm.selected_suit = $event.target.multiple
                                ? $$selectedVal
                                : $$selectedVal[0]
                            },
                            _vm.storeSuit
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.suit_avoid_list, function(item, index) {
                          return _c(
                            "option",
                            { key: index, domProps: { value: item.name } },
                            [
                    ...
                    _c("br"),
                    _vm._v(" "),
                    _vm._l(_vm.data.selected_suit_list, function(item, index) {
                ...
                _c(
                  "td",
                  [
                    _c("label", { attrs: { for: "" } }, [_vm._v("Avoid")]),
                    _vm._v(" "),
                    _c("br"),
                    _vm._v(" "),
                    _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.selected_avoid,
                            expression: "selected_avoid"
                          }
                        ],
                        staticClass: "form-control",
                        on: {
                          change: [
                            function($event) {
                              ...
                              _vm.selected_avoid = $event.target.multiple
                                ? $$selectedVal
                                : $$selectedVal[0]
                            },
                            _vm.storeAvoid
                    ...
                    _c("br"),
                    _vm._v(" "),
                    _vm._l(_vm.data.selected_avoid_list, function(item, index) {
                      return _c("div", { key: index }, [
                        _vm._v(
                          "\n                                " +
                            _vm._s(item) +

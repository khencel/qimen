...
<script>
    ...
    export default {
        ...
        methods:{
           ...
           deleteAttributes(id){
               axios.post('/api/trigram/delete/attributes?api_token='+window.token,{attributes_name:this.form.attributes_name,id:id})
               .then(res => {
                   this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            showAttributes(){
                this.form.put('/api/trigram/show/attributes/'+this.id+'?api_token='+window.token)
                .then(res => {

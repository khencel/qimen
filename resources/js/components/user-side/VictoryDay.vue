        ...
        <div class="row justify-content-center" id="print">
            <div class="col-md-11">
                <div v-for="(item, index) in month_list" :key="index" class="mt-3 p-2 print-style" style="border-width:5px;border-style:outset;">
                    ...
                    <div class="row m-0 p-0 calendar-style" style="background-image:url('/img/poenixTrans.png');background-size: 30% 50%;background-repeat:no-repeat;background-position:center center;">

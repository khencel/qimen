...
<script>
    import Preview from '../star/Preview';
    export default {
        components:{
            Preview
        },
        ...
        methods:{
           addAttributes(){
               this.form.put('/api/star/store/'+this.id+'?api_token='+window.token)
               .then(res => {
                    this.$notify({
                        group: 'notification',
                        type:'success',
           ...
           deleteAttributes(id){
               axios.post('/api/star/delete/attributes?api_token='+window.token,{attribute_name:this.form.attribute_name,id:id})
               .then(res => {
                   this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            showAttributes(){
                this.form.put('/api/star/show/'+this.id+'?api_token='+window.token)
                .then(res => {

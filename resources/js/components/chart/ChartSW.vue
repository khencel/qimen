<template>
    <div>
        ...
        <div class="row mt-2">
            <div class="col-md-5">
                <div class="row justify-content-start pt-5 text-center bg-black position-relative">
                    <div class="text-white position-absolute m-1" style="z-index:1;top:0;right:0">
                        <h3>SW</h3>
                    </div>
                    <div class=" position-absolute mt-1" style=";width:100px;z-index:1;top:0;right:50%;margin-right:-27px;">
                        <div class="row justify-content-center">
                            <div  v-for="(item, index) in outsidePositions" :key="index" class="col-6">
                                ...
                                <br>
                                <input type="checkbox" v-model="se.swTop" :value="item.value">
                            </div>
                        </div>
                    </div>
                    <div class="position-absolute" style="height:100px;z-index:1;top:50%;right:0;margin-top:-50px;">
                        <div v-for="(item, index) in outsidePositions" :key="index" class="h-50 pt-2">
                            <input type="checkbox" v-model="se.swRight" :value="item.value">
                            <b-badge variant="success" class="p-2" v-text="item.value"></b-badge>
            ...
            <div class="col-md-7 border">
                <div class=" pt-4 pb-4 pl-5 pr-5 position-relative" style="background-color:black">
                    ...
                    <div class=" position-absolute text-center" style="width:60px;z-index:1;top:0;right:16.3%">
                        <div class="row justify-content-center text-white" >
                            <div v-for="(item, index) in se.swTop" :key="index" class="col-6" v-show="item != ''">
                                <b-badge variant="success" v-text="item"></b-badge>
                            </div>
                        </div>
                    </div>

                    <div class=" position-absolute" style="height:50px;z-index:1;top:16%;right:0">
                        <div v-for="(item, index) in se.swRight" :key="index">
                            <b-badge variant="success" v-text="item"></b-badge>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            chartUpdate(){
                ...
                this.se.put('/api/sw/'+this.chart_id)
                .then(response => {
                    this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            chartDetails(){
                this.se.get('/api/sw/'+this.chart_id+'/'+this.type)
                .then(response => {
                    ...
                    response.data.se.swTop.split(",").forEach(element => {
                        this.se.swTop.push(element);
                    });

                    response.data.se.swRight.split(",").forEach(element => {
                        this.se.swRight.push(element);
                    });
                })
                .catch(error => {

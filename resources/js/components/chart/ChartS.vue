<template>
    <div>
        ...
        <div class="row mt-2">
            <div class="col-md-5">
                <div class="row pt-5 text-center bg-black position-relative">
                    <div class=" text-white position-absolute w-100" style="z-index:1;top:0;">
                            ...
                            <div class="col-2" style="margin-left:-90px;">
                               <div class="row">
                                   <div v-for="(item, index) in outsidePositions" :key="index" class="col-6 text-center p-0">
                                       ...
                                       <input type="checkbox" v-model="se.sTop" :value="item.value">
                                   </div>
                               </div>
                            </div>
                            <div class="col-1 h3">
            ...
            <div class="col-md-7 border">
                <div class=" pt-4 pb-4 pl-5 pr-5 position-relative" style="background-color:black">
                    ...
                    <div class=" position-absolute" style="width:30px;top:0;left:43%;z-index:1">
                        <div class="row justify-content-center">
                            <div class="col-6 p-0" v-for="(item, index) in se.sTop" :key="index">
...
<script>
    export default {
        ...
        methods:{
            ...
            chartUpdate(){
                this.se.put('/api/south/'+this.chart_id)
                .then(response => {
            ...
            chartDetails(){
                this.se.get('/api/south/'+this.chart_id+'/'+this.type)
                .then(response => {
                    console.log(response.data);
                    ...
                    response.data.se.sTop.split(',').forEach(element => {
                        this.se.sTop.push(element);
                    });
            ...
            fetchChartPosition(){
                axios.get('/api/south/'+this.chart_id+'/'+this.type)
                .then(response => {
                        ...
                        this.se.position_7 = response.data.position.position_7 == null?this.se.position_7 = {id:0,fword:'',lword:''}:{id:response.data.position.position_7.id,fword:response.data.position.position_7.first_word,lword:response.data.position.position_7.second_word}; 
                })

            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    <tr v-for="chart in charts.data" :key="chart.id">
                        <td>{{chart.id}}</td>
                        <td v-if="chart.cycle_type == 'Upper Cycle'">{{chart.id*2 +10}}</td>
                        <td v-else-if="chart.cycle_type == 'Middle Cycle'" >{{chart.id*2 +12}}</td>
                        <td v-else-if="chart.cycle_type == 'Lower Cycle'" >{{chart.id*2 +14}}</td>
                        <td v-else>{{chart.id*2 +6}}</td>
                        <td>{{chart.structure_type}}</td>
                        <td>{{chart.cycle_type}}</td>
                        <td>Yin {{chart.number}}</td>

<template>
    <div>
        ...
        <div class="row mt-2">
            <div class="col-md-5">
                <div class="row justify-content-end text-center bg-black position-relative">
                    <div class="text-white position-absolute m-1" style=";height:30px;z-index:1;bottom:50%;left:0;margin-bottom:-15px;">
                        <h3>E</h3>
                    </div>
                    <div class="position-absolute" style="height:100px;z-index:1;top:60%;left:0;margin-top:-50px;">
                        <div v-for="(item, index) in outsidePositions" :key="index" class="h-50 pt-2">
                            ...
                            <input type="checkbox" v-model="se.eLeft" :value="item.value">
                        </div>
                    </div>
            ...
            <div class="col-md-7 border">
                <div class=" pt-4 pb-4 pl-5 pr-5 position-relative" style="background-color:black">
                    ...
                    <div class=" position-absolute" style="height:50px;z-index:1;top:52%;left:0">
                        <div v-for="(item, index) in se.eLeft" :key="index">
...
<script>
    export default {
        ...
        methods:{
            ...
            chartUpdate(){
                this.se.put('/api/east/'+this.chart_id)
                .then(response => {
                    this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            chartDetails(){
                this.se.get('/api/east/'+this.chart_id+'/'+this.type)
                .then(response => {
                    ...
                    response.data.se.eLeft.split(",").forEach(element => {
                        this.se.eLeft.push(element);
                    });

<template>
    <div>
        ...
        <div class="row mt-2">
            <div class="col-md-5">
                <div class="row justify-content-start text-center pb-5 bg-black position-relative">
                    <div class="text-white position-absolute m-1" style=";z-index:1;bottom:0;right:0;">
                        <h3>NW</h3>
                    </div>
                     <div class=" position-absolute" style=";width:100px;z-index:1;bottom:0;left:50%;margin-left:-80px;">
                        <div class="row justify-content-center">
                            <div  v-for="(item, index) in outsidePositions" :key="index" class="col-6">
                                ...
                                <br>
                                <input type="checkbox" v-model="se.nwBottom" :value="item.value">
                            </div>
                        </div>
                    </div>
                    <div class="position-absolute" style="height:100px;z-index:1;top:45%;right:0;margin-top:-50px;">
                        <div v-for="(item, index) in outsidePositions" :key="index" class="h-50 pt-2">
                            <b-badge variant="success" class="p-2" v-text="item.value"></b-badge>
                            <input type="checkbox" v-model="se.nwRight" :value="item.value">
                        </div>
                    </div>
            ...
            <div class="col-md-7 border">
                <div class=" pt-4 pb-4 pl-5 pr-5 position-relative" style="background-color:black">
                    ...
                    <div class=" position-absolute text-center" style="width:60px;z-index:1;bottom:0;right:16.3%">
                        <div class="row justify-content-center text-white" >
                            <div v-for="(item, index) in se.nwBottom" :key="index" class="col-6" v-show="item != ''">
                                <b-badge variant="success" v-text="item"></b-badge>
                            </div>
                        </div>
                    </div>

                    <div class=" position-absolute" style="height:50px;z-index:1;bottom:16%;right:0">
                        <div v-for="(item, index) in se.nwRight" :key="index">
                            <b-badge variant="success" v-text="item"></b-badge>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            chartUpdate(){
                this.se.put('/api/nw/'+this.chart_id)
                .then(response => {
                    this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            chartDetails(){
                this.se.get('/api/nw/'+this.chart_id+'/'+this.type)
                .then(response => {
                    ...
                    response.data.se.nwBottom.split(",").forEach(element => {
                        this.se.nwBottom.push(element);
                    });

                    response.data.se.nwRight.split(",").forEach(element => {
                        this.se.nwRight.push(element);
                    });
                })
                .catch(error => {

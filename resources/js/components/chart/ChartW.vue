<template>
    <div>
        ...
        <div class="row mt-2">
            <div class="col-md-5">
                <div class="row justify-content-start text-center bg-black position-relative">
                    <div class="text-white position-absolute m-1" style=";height:30px;z-index:1;bottom:50%;right:0;margin-bottom:-15px;">
                        <h3>W</h3>
                    </div>
                    <div class="position-absolute" style="height:100px;z-index:1;bottom:60%;right:0;margin-top:-50px;">
                        <div v-for="(item, index) in outsidePositions" :key="index" class="h-50 pt-2">
                            ...
                            <input type="checkbox" v-model="se.wRight" :value="item.value">
                        </div>
                    </div>
            ...
            <div class="col-md-7 border">
                <div class=" pt-4 pb-4 pl-5 pr-5 position-relative" style="background-color:black">
                    ...
                    <div class=" position-absolute" style="height:50px;z-index:1;bottom:52%;right:0">
                        <div v-for="(item, index) in se.wRight" :key="index">
...
<script>
    export default {
        ...
        methods:{
            ...
            chartUpdate(){
                this.se.put('/api/west/'+this.chart_id)
                .then(response => {
            ...
            chartDetails(){
                this.se.get('/api/west/'+this.chart_id+'/'+this.type)
                .then(response => {
                    ...
                    response.data.se.wRight.split(",").forEach(element => {
                        this.se.wRight.push(element);
                    });

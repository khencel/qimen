...
<script>
    import Preview from '../door/PreviewStem';
    ...
    export default {
        ...
        methods:{
           addAttributes(){
               this.loading = true;
               this.form.put('/api/door/store/'+this.id+'?api_token='+window.token)
               .then(res => {
                    this.loading = false;
                    this.$notify({
                        group: 'notification',
           ...
           deleteAttributes(id){
               axios.post('/api/door/delete/attributes?api_token='+window.token,{attribute_name:this.form.attribute_name,id:id})
               .then(res => {
                   this.$notify({
                        group: 'notification',
                        type:'success',
            ...
            showAttributes(){
                this.form.put('/api/door/show/'+this.id+'?api_token='+window.token)
                .then(res => {
